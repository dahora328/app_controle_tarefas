...
class RedefinirSenhaNotification extends Notification
{
    ...
    {
        $url = 'http://localhost:80/password/reset/'.$this->token. '?email='.$this->email ;
        ...
        return (new MailMessage)
            ...
            ->line('Caso você não tenha requistrado a alteração de senha, então nenhuma ação é necessária.')
